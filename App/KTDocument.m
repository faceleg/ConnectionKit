...
- (BOOL)backupToURL:(NSURL *)anotherURL;
{
    ...
    // We can't backup to the same location
    if (![[[anotherURL path] stringByResolvingSymlinksInPath] isEqualToString:[[[self fileURL] path] stringByResolvingSymlinksInPath]])
    {
