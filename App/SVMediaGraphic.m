...
- (NSString *)plugInIdentifier;
{
    ...
    {
        return [[[SVGraphicFactory videoFactory] identifiers] objectAtIndex:0];
    }
    ...
    {
        return [[[SVGraphicFactory audioFactory] identifiers] objectAtIndex:0];
    }
    ...
    {
        return [[[SVGraphicFactory flashFactory] identifiers] objectAtIndex:0];
    }
    else
    {
        return [[[SVGraphicFactory mediaPlaceholderFactory] identifiers] objectAtIndex:0];
    }
}
