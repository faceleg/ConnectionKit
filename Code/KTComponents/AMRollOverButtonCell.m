...
- (void) showMenuForEvent:(NSEvent *)theEvent inRect:(NSRect)cellFrame ofView:(NSView *)controlView
{
...
- (BOOL)trackMouse:(NSEvent *)theEvent inRect:(NSRect)cellFrame ofView:(NSView *)controlView untilMouseUp:(BOOL)untilMouseUp
{
	...
	if ([self menu]) {
		...
		if (localPoint.x >= (am_textRect.origin.x+am_textRect.size.width)) {
			...
			result = YES;
			[self showMenuForEvent:theEvent inRect:cellFrame ofView:controlView];
		}
	}
