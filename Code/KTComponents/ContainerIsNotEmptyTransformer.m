//
//  ContainerIsNotEmptyTransformer.m
//  Marvel
//
...
PURPOSE OF THIS CLASS/CATEGORY:
	Simple transformer for general use in UIs.  Returns NO when the given object is empty, e.g. an empty string, an empty array, etc.
...
@implementation ContainerIsNotEmptyTransformer
